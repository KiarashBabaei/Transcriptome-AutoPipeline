...
| Color | Type | Steps |
|-------|------|-------|
| 🔵 Blue | Input | SRA Archive |
| 🟢 Green | Metadata | GEO, Merge, Select |
| 🟤 Dark | Tools | prefetch, fasterq-dump, Salmon, SUPPA2 |
| 🟣 Purple | Intermediates | TPM Matrix, RI Events |
| 🟠 Orange | Output | PSI Output |
